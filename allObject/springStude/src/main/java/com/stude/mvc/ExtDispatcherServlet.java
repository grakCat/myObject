...
//    private String path;
//
//    public ExtDispatcherServlet(String path){
//            this.path = path;
//    }
//
//    /**
...
//                // 默认类名小写 作为bean的名称
//                String beanId = MvcClassUtil.toLowerCaseFirstOne(classInfo.getSimpleName());
//                mvcBeans.put(beanId, MvcClassUtil.newInstance(classInfo));
//            }
//        }
//
//    }
